...
const Shop = () => {
  ...
  return (
    <div className="w-full lg:py-64 py-4 border pb-[199px]">
          ...
          <section className="flex flex-col pt-[47px] pb-6">
            ...
            <ul className="space-y-3 py-3 border-b">
              <li>
                ...
                <label htmlFor="sale1" className="relative sale2 before:w-5 before:h-5 before:border active:before:border-[6px] before:top-[10%] before:left-[-90%] active:before:border-[#17AF26] before:rounded-[50%] before:absolute">
                  Sale
                </label>
        ...
        <div className="w-full flex flex-col mb:items-center lg:items-start">
          <div className="w-full flex justify-between items-center border-b pb-6">
            ...
            <div className="flex gap-x-[10px]">
              <div className="relative lg:hidden group w-[78px] flex items-center gap-x-2 h-[34px] border rounded-[100px] px-3 cursor-pointer border-gray-300 text-gray-700 text-xs tracking-[-0.5px]">
                Filter
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-chevron-down group-hover:rotate-180 duration-300">
                  <path d="m6 9 6 6 6-6" />
                </svg>
            ...
            {products.map(item => (
                <div className="grid grid-cols-1 snap-center auto-rows-[240px_auto] gap-y-4 overflow-hidden h-full rounded-xl">
                    ...
                    <div className="relative group w-full h-[240px] bg-[#f4f4f4] rounded-xl grid place-items-center">
                        <img className="w-[164px] h-[164px]" src={item.thumbnail} alt="" />
                        <button className="absolute scale-0 group-hover:scale-100 group-hover:translate-y-0 -translate-y-[200%] duration-200 z-[2] w-[152px] h-[64px] rounded-[100px] bg-[#1A1E2630] text-sm text-white backdrop-blur-md">Out Of Stock</button>
                    ...
                    <div className="w-full flex flex-col justify-between gap-y-5 items-center">
                        ...
                        <strong className="uppercase font-light text-sm text-[#9D9EA2]">FLOWER</strong>
                        <strong className="text-lg text-center line-clamp-2 font-normal text-[#1A1E26]">{item.name}</strong>
                        <section className="w-[163px] h-[21px] flex justify-between items-start">
                            <div className="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-star">
                        ...
                        <section className="bg-[#F2F6F4] w-[92px] h-[28px] text-xs rounded grid place-items-center">Sativa 100%</section>
                        </div>
                        <div className="flex flex-col gap-y-2 items-center">
                        ...
                        <button className="w-[160px] h-[40px] rounded-[1000px] bg-[#17AF26] text-white">Add To Cart</button>
                        </div>
                    </div>
                </div>
            ))}
          ...
          <div className="flex flex-col lg:items-end items-center w-full mt-8 gap-y-3">
            <div className="grid gap-3 grid-cols-[repeat(7,1fr)] mb:grid-cols-[repeat(2,1fr)] w-full mb:w-auto justify-items-center mb:justify-items-stretch">
              <button className="w-[38px] h-[38px] bg-[#F3FBF4] text-[#17AF26] rounded-[8px]">1</button>
              <button className="w-[38px] h-[38px] bg-[#17AF26] text-white rounded-[8px]">2</button>
              <button className="w-[38px] h-[38px] bg-[#F3FBF4] text-[#17AF26] rounded-[8px]">3</button>
              <button className="w-[38px] h-[38px] bg-[#F3FBF4] text-[#17AF26] rounded-[8px]">4</button>
              <button className="w-[38px] h-[38px] bg-[#F3FBF4] text-[#17AF26] rounded-[8px]">5</button>
              <button className="w-[38px] h-[38px] bg-[#F3FBF4] text-[#17AF26] rounded-[8px]">6</button>
              <button className="w-[38px] h-[38px] bg-[#F3FBF4] text-[#17AF26] rounded-[8px]">7</button>
            </div>
            <button className="bg-[#17AF26] text-white w-[170px] h-[50px] rounded-[100px]">Show All</button>
          </div>
        </div>
      </div>
    </div>
